/*
 * Class:   DirectoryCleanerDriver.java
 * Born On: Jan, 2012
 * Purpose: Class DirectoryCleanerDriver is a bootstrap class that will invoke a fgb.io.DirectoryCleaner.
 */
package org.fgb.io.filecache.driver;

import org.fgb.io.filecache.DirectoryCleaner;
...
/**
 * Class <code>DirectoryCleanerDriver</code> is a bootstrap class that will invoke a {@linkplain fgb.io.DirectoryCleaner}.
 * <p>
 * @author Frederick Burkley
 */
public class DirectoryCleanerDriver {
	/**
	 * The name of this class.
	 */
	private static final String _className = DirectoryCleanerDriver.class.getName();
	/**
	 * JDK logger.
	 */
	...
	public static void main(String[] args) {
		...
		DirectoryCleaner monitor = new DirectoryCleaner(directoryName);
		try {
			monitor.start();
		} catch (Exception ex) {
